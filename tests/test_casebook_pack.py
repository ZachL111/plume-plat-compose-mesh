"""Regression checks for the plume-plat-compose-mesh casebook."""
...
from casebook.harness import assert_expected, plume_plat_compose_mesh_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(plume_plat_compose_mesh_summary(), assert_expected())
