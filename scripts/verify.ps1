...
powershell -NoProfile -ExecutionPolicy Bypass -File scripts/check-plume-plat-compose-detail.ps1

powershell -NoProfile -ExecutionPolicy Bypass -File scripts/check-plume-plat-compose-properties.ps1
if ($LASTEXITCODE -ne 0) { exit $LASTEXITCODE }

powershell -NoProfile -ExecutionPolicy Bypass -File scripts/check-plume-plat-compose-golden.ps1
if ($LASTEXITCODE -ne 0) { exit $LASTEXITCODE }

powershell -NoProfile -ExecutionPolicy Bypass -File scripts/check-plume_plat_compose_mesh-casebook.ps1
if ($LASTEXITCODE -ne 0) { exit $LASTEXITCODE }
